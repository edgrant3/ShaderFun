    ...
    shaderControls(new ShaderControls())
{
    ...
    connect(shaderControls, SIGNAL(sig_setCurrentPostSurfaceShaderProgram(int)), ui->mygl, SLOT(slot_setCurrentPostSurfaceShaderProgram(int)));
    connect(shaderControls, SIGNAL(sig_setInstancedGridRes(double)), ui->mygl, SLOT(slot_setInstancedGridRes(double)));
    connect(shaderControls, SIGNAL(sig_setInstancedGridSpacing(int)), ui->mygl, SLOT(slot_setInstancedGridSpacing(int)));
