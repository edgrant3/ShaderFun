...
#include <shaderprograms/postsurfaceshader.h>
#include "texture.h"
...
private:
    ...
    std::vector<std::shared_ptr<PostSurfaceShader>> m_postsurfaceShaders;
    bool usePostSurfaceShaders;
    ...
    PostSurfaceShader* mp_progPostSurfaceCurrent;
    ...
    glm::mat4 m_commonModelTransform;
    std::vector<std::shared_ptr<InstancedShapeGrid>> m_instancedgrids;
//    std::shared_ptr<Mesh> instancedCubeGrid;
    ...
    InstancedShapeGrid* mp_instancedgridCurrent;
    ...
    GLuint m_secondaryframeBuffer;
    GLuint m_secondaryrenderedTexture;
    GLuint m_secondarydepthRenderBuffer;

    GLuint m_depthTexture;
    GLuint m_secondarydepthTexture;
